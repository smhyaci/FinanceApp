...
class GraphPeer(MDCard, RectangularElevationBehavior):
    ...
    def display_filter_setup(self):
        ...
        try:
            ...
            self.ids.filter_panel.size_hint_x = 0.3
        ...
        if active_filter == "cost":
            ...
            self.filter.pos_hint = {"center_x": 0.5, }
            ...
            self.filter_low.pos_hint = {"center_x": 0.5, }
            
            self.filter_high = MDTextField(
                hint_text='Filter: Amount High', icon_right='cash')
            self.filter_high.pos_hint = {"center_x": 0.5, }
            
            self.ids.filter_panel.size_hint_x = 0.5
